...
SECRET_KEY = "w1h4+wpir*t+g4-g^as68)^n0*cmu19zxli%d)ash05yj*osw#"
...
ACCOUNT_LOGOUT_REDIRECT_URL = "courses:index"
...
CRISPY_CLASS_CONVERTERS = {"fileinput": "custom-file-input"}
